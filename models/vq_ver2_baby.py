...
后面要做的实验: 两个模态共享一个码本,码本搜超参数 又能衍生出两个版本 
VQ Loss影响这么大吗? 
"""
...
class VQ_VER2_BABY(GeneralRecommender):
    def __init__(self, config, dataset):
        super(VQ_VER2_BABY, self).__init__(config, dataset)
    ...
    def calculate_loss(self, interaction):
        ...
        # v_common_vq = self.v_proj(v_output)
        # t_common_vq = self.t_proj(t_output)
