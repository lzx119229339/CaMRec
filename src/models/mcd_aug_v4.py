...
class MCD_AUG_V3(GeneralRecommender):
    def __init__(self, config, dataset):
        super(MCD_AUG_V3, self).__init__(config, dataset)
    ...
    def calculate_loss(self, interaction):
        ...
        self.forward(t_unigrpah,v_unigraph,v_share,t_share)
        
        
        
        
        loss_rec_main = self.BPR(self.t_rep) + self.BPR(self.v_rep)
        loss_rec_aug = self.BPR(self.t_aug)
        ...
        ssl_loss = self.ssl_weight * (ssl_loss_t_aug ) 
