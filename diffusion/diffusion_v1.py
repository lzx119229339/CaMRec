...
class diffusion(nn.Module):
    ...
    def p_losses(self, x1_start, x2_start, t, noise=None, loss_type="l2"):
        ...
        diff_i = torch.cat([x_noisy.unsqueeze(1), x2_start.unsqueeze(1), t_emb.unsqueeze(1)], dim=1)
    ...
    def p_sample(self, x1_t, x2_t, t, t_index):
        ...
        diff_i = torch.cat([x1_t.unsqueeze(1), x2_t.unsqueeze(1), t_emb.unsqueeze(1)], dim=1)
