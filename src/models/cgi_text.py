...
class CGI_TEXT(GeneralRecommender):
    def __init__(self, config, dataset):
        super(CGI_TEXT, self).__init__(config, dataset)
    ...
    def forward(self):
        ...
        x_t= torch.cat((self.t_prefer,t_feat),dim=0) 
        x_t = F.normalize(x_t) 
    ...
    def calculate_loss(self, interaction):
        ...
        loss_rec_t = self.BPR(self.result_embed) 
        loss_rec_ed = self.BPR(self.result_embed_ED) 
        loss_rec = loss_rec_t + loss_rec_ed
