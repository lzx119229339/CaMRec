...
class MCD_AUG_V2(GeneralRecommender):
    def __init__(self, config, dataset):
        super(MCD_AUG_V2, self).__init__(config, dataset)
    ...
    def forward(self):
        ...
        t_unigraph = torch.sparse.mm(self.text_original_adj,t_feat_ori)
        ...
        self.t_rep,self.t_aug = self.aug(self.t_prefer,t_unigraph,self.text_graphlearner)
        # self.v_rep,self.v_aug = self.aug(self.v_prefer,v_unigraph,self.image_graphlearner)
    ...
    def calculate_loss(self, interaction):
        ...
        diff_loss1,v_share = self.diffusion_tgi.p_losses(v_unigraph,t_feat_ori,t) 
        diff_loss2,t_share = self.diffusion_igt.p_losses(t_unigrpah,v_feat_ori,t)
    ...
    def sample(self):
        ...
        # t_unigrpah = torch.sparse.mm(self.text_original_adj,t_feat_ori)
        # v_unigraph = torch.sparse.mm(self.image_original_adj,v_feat_ori)
        # v_share = self.diffusion_tgi.sample(v_unigraph,t_feat_ori) 
        # t_share = self.diffusion_igt.sample(t_unigrpah,v_feat_ori)
